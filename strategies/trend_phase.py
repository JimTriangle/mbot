...
class TrendPhaseStrategy(BaseStrategy):
    """
    Stratégie de détection de phases de tendance.
    ...
    Génère des signaux SELL lors du début d'une tendance baissière forte
    ou de la fin d'une tendance haussière.
    """
